...
pnet.setup_cifti_volume(os.path.join(pnet.dir_example,
                                     'HCP_Surface-Volume/Data/100206/rfMRI_REST1_LR_Atlas_MSMAll_hp2000_clean.dtseries.nii'),
...
if __name__ == '__main__':
    pnet.setup_brain_template(os.path.join(pnet.dir_brain_template, 'HCP_Surface_Volume'),
                              ...
                              maskValue=0,  # HCP uses 1 to label medial wall
                              file_surfL_inflated=file_surfL_inflated, file_surfR_inflated=file_surfR_inflated,
                              file_mask_vol=os.path.join(pnet.dir_brain_template,
                                                         'HCP_Surface_Volume/CIFTI_Volume.nii.gz'),
