...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Generate a brain template for computing function networks from volumetric data.')
    ...
    Brain_Mask, _, _ = load_fmri_scan(args.mask, dataType=dataType, dataFormat='Volume (*.nii, *.nii.gz, *.mat)',
                                      Reshape=False, Normalization=None)
    Overlay_Image, _, _ = load_fmri_scan(args.overlay, dataType=dataType, dataFormat='Volume (*.nii, *.nii.gz, *.mat)',
                                         Reshape=False, Normalization=None)
